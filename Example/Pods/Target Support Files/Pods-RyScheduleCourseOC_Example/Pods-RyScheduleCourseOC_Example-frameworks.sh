...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/RyCyxbsExtensionOC/RyCyxbsExtensionOC.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RyScheduleCourseOC/RyScheduleCourseOC.framework"
