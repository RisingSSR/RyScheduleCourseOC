...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of RyScheduleCourseOC.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/RySi Sun/RyScheduleCourseOC'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'RySi Sun' => '2769119954@qq.com' }
  s.source           = { :git => 'https://github.com/RySi Sun/RyScheduleCourseOC.git', :tag => s.version.to_s }
